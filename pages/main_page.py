...
class YandexScooterMainPage(YandexScooterBasePage):
    ...
    @allure.step('Подождать загрузки заголовка "Самокат на пару дней" и вывести его текст')
    def wait_for_load_main_page_and_get_text(self):
        title = self.find_element_located(MainPageLocators.HOME_PAGE_HEADER)
        return title.text

    @allure.step('Подождать загрузки заголовка "Самокат на пару дней" и кликнуть по кнопке "да все привыкли"')
    def wait_for_load_main_page_and_click_everyone_is_used_to_it_button(self):
        WebDriverWait(self.driver, 5).until(EC.visibility_of_element_located(MainPageLocators.HOME_PAGE_HEADER))
        self.driver.find_element(*BasePageLocators.EVERYONE_IS_USED_TO_IT_BUTTON).click()
    ...
    def wait_for_drop_down_list_want_several_scooters_at_once_button_and_get_text(self):
        drop_down_list = self.find_element_located(MainPageLocators.DROP_DOWN_LIST_WANT_SEVERAL_SCOOTERS_AT_ONCE_BUTTON)
        return drop_down_list.text
    ...
    def wait_for_drop_down_list_how_is_the_rental_time_calculated_button_and_get_text(self):
        drop_down_list = self.find_element_located(MainPageLocators.DROP_DOWN_LIST_HOW_IS_THE_RENTAL_TIME_CALCULATED_BUTTON)
        return drop_down_list.text
    ...
    def wait_for_drop_down_list_is_it_possible_to_order_a_scooter_right_for_today_button_and_get_text(self):
        drop_down_list = self.find_element_located(MainPageLocators.DROP_DOWN_LIST_IS_IT_POSSIBLE_TO_ORDER_A_SCOOTER_RIGHT_FOR_TODAY_BUTTON)
        return drop_down_list.text
    ...
    def wait_for_drop_down_list_is_it_possible_to_extend_the_order_or_return_the_scooter_earlier_button_and_get_text(self):
        drop_down_list = self.find_element_located(MainPageLocators.DROP_DOWN_LIST_IS_IT_POSSIBLE_TO_EXTEND_THE_ORDER_OR_RETURN_THE_SCOOTER_EARLIER_BUTTON)
        return drop_down_list.text
    ...
    def wait_for_drop_down_list_you_bring_the_charger_along_with_the_scooter_button_and_get_text(self):
        drop_down_list = self.find_element_located(MainPageLocators.DROP_DOWN_LIST_YOU_BRING_THE_CHARGER_ALONG_WITH_THE_SCOOTER_BUTTON)
        return drop_down_list.text
    ...
    def wait_for_drop_down_list_is_it_possible_to_cancel_the_order_button_and_get_text(self):
        drop_down_list = self.find_element_located(MainPageLocators.DROP_DOWN_LIST_IS_IT_POSSIBLE_TO_CANCEL_THE_ORDER_BUTTON)
        return drop_down_list.text
    ...
    def wait_for_drop_down_list_i_live_across_the_mkad_will_you_bring_me_button_and_get_text(self):
        drop_down_list = self.find_element_located(MainPageLocators.DROP_DOWN_LIST_I_LIVE_ACROSS_THE_MKAD_WILL_YOU_BRING_ME_BUTTON)
        return drop_down_list.text
